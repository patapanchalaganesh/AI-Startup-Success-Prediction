...
def evaluate_startup_model(data_path='data/processed_data.csv', model_dir='models'):
    ...
    model_path = os.path.join(BASE_DIR, model_dir, 'user_best_model.pkl')
    prep_path = os.path.join(BASE_DIR, model_dir, 'user_preprocessor.pkl')
    ...
    if not os.path.exists(full_data_path):
        full_data_path = 'data/processed_data.csv'
